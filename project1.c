...
main()
{
        ...
        switch(choice)
        {
        	case '1':
        		...
        		s=fopen("C:/Users/harsh/OneDrive/Desktop/PSP/number.txt","r");
        		fscanf(s,"%d",&number);
        	    k=number;
        		int n=0;
        	for(i=k;n<num;i++,n++)
...
{
	struct bank b;
	w=fopen("C:/Users/harsh/OneDrive/Desktop/PSP/v_value.txt","r");
		fscanf(w,"%d",&v);
		printf("\n\t\t\t\t\t\t\t - - - - - - - - - - - - - - - -");
        ...
        fscanf(s,"%d",&number);
	   	number++;
        		...
        		fprintf(s,"%d",number);
        		fclose(s);
	h=fopen("C:/Users/harsh/OneDrive/Desktop/PSP/bankaccount.txt","a");
...
void deposit(struct bank b[100])
{
		...
		scanf("%lld",&acc_num);
			s=fopen("C:/Users/harsh/OneDrive/Desktop/PSP/number.txt","r");
        	fscanf(s,"%d",&number);
			h=fopen("C:/Users/harsh/OneDrive/Desktop/PSP/bankaccount.txt","r");
			y=fopen("C:/Users/harsh/OneDrive/Desktop/PSP/copyaccount.txt","w");
			w=fopen("C:/Users/harsh/OneDrive/Desktop/PSP/v_value.txt","r");
			fscanf(w,"%d",&v);
		...
		printf("\n\t\t\t\t\t\t\t***ACCOUNT NOT MATCHED***");
		fclose(h);	
		s=fopen("C:/Users/harsh/OneDrive/Desktop/PSP/bankaccount.txt","w");
		y=fopen("C:/Users/harsh/OneDrive/Desktop/PSP/copyaccount.txt","r");
...
void delete(struct bank b[100])
{
	...
	printf("\n\t\t\t\t\t\t\tENTER THE ACCOUNT NUMBER DO YOU WANT TO DELETE :");
		...
		s=fopen("C:/Users/harsh/OneDrive/Desktop/PSP/number.txt","r");
        fscanf(s,"%d",&number);
    z=fopen("C:/Users/harsh/OneDrive/Desktop/PSP/copyaccount.txt","w");
	h=fopen("C:/Users/harsh/OneDrive/Desktop/PSP/bankaccount.txt","r");
	w=fopen("C:/Users/harsh/OneDrive/Desktop/PSP/v_value.txt","r");
	fscanf(w,"%d",&v);
	for(q=0;q<number-v;q++)
	...
	{
		v++;
			w=fopen("C:/Users/harsh/OneDrive/Desktop/PSP/v_value.txt","w");
			fprintf(w,"%d",v);
			fclose(w);
			w=fopen("C:/Users/harsh/OneDrive/Desktop/PSP/v_value.txt","r");
			fscanf(w,"%d",&v);
	...
	fclose(h);
	fclose(z);
		m=fopen("C:/Users/harsh/OneDrive/Desktop/PSP/copyaccount.txt","r");
		h=fopen("C:/Users/harsh/OneDrive/Desktop/PSP/bankaccount.txt","w");
		for(q=0;q<number-v;q++)
		{
		fscanf(m,"\n |  %5d  |  %15s  |  %10s  |   %15s   |  %10s  |  %10lld  |  %15lld  |",&i,b[q].name,b[q].address,b[q].addhar,&b[q].phone_num,&b[q].balance,&b[q].account);
	  	fprintf(h,"\n |  %5d  |  %15s  |  %10s  |   %15s   |  %10s  |  %10lld  |  %15lld  |",i,b[q].name,b[q].address,b[q].addhar,b[q].phone_num,b[q].balance,b[q].account);
